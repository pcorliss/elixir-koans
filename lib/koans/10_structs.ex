defmodule Structs do
  ...
  koan "Unless previously defined, fields begin as nil" do
    ...
    someone = put_in(nobody.age, 25)
    assert someone.age == 25
    other = %{nobody | age: 30}
    assert other.age == 30
    # Doesn't work - structs are immutable
    # last_one = someone.age = 40
    # assert last_one == 40
  end
  ...
  koan "Use the put_in macro to replace a nested value" do
    ...
    # We don't need to fill out the defaults here because they are already defaulted
